...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'oc_platform_accueil');
            }

            return array (  '_controller' => 'OC\\PlatformBundle\\Controller\\AdvertController::indexAction',  '_route' => 'oc_platform_accueil',);
        }
        ...
        if (0 === strpos($pathinfo, '/platform')) {
            ...
            if (0 === strpos($pathinfo, '/platform/a')) {
                ...
                if (0 === strpos($pathinfo, '/platform/ajax') && preg_match('#^/platform/ajax(?:/(?P<category>[^/]++)(?:/(?P<lat>[^/]++)(?:/(?P<lng>[^/]++)(?:/(?P<dist>[^/]++)(?:/(?P<q>[^/]++))?)?)?)?)?$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'oc_platform_view_ajax')), array (  '_controller' => 'OC\\PlatformBundle\\Controller\\AdvertController::ajaxAction',  'category' => '',  'lat' => '',  'lng' => '',  'dist' => '',  'q' => '',));
                }
            ...
            if ($pathinfo === '/platform/password') {
                return array (  '_controller' => 'OC\\PlatformBundle\\Controller\\AdvertController::passwordAction',  '_route' => 'oc_platform_password',);
            }
            ...
            if (preg_match('#^/platform/(?P<year>\\d{4})/(?P<slug>[^/\\.]++)(?:\\.(?P<_format>html|xml)(?:\\.(?P<_locale>[^/]++))?)?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'oc_platform_view_slug')), array (  '_controller' => 'OC\\PlatformBundle\\Controller\\AdvertController::viewSlugAction',  '_format' => 'html',  '_locale' => 'fr',));
            }
        ...
        if (0 === strpos($pathinfo, '/user')) {
            ...
            if ($pathinfo === '/user/login') {
                return array (  '_controller' => 'OC\\Bundle\\UserBundle\\Controller\\UserController::loginAction',  '_route' => 'oc_platform_user',);
            }

            // oc_platform_user_password
            if ($pathinfo === '/user/password') {
                return array (  '_controller' => 'OC\\Bundle\\UserBundle\\Controller\\UserController::passwordAction',  '_route' => 'oc_platform_user_password',);
            }

            // oc_platform_user_create
            if ($pathinfo === '/user/create') {
                return array (  '_controller' => 'OC\\Bundle\\UserBundle\\Controller\\UserController::createAction',  '_route' => 'oc_platform_user_create',);
            }
